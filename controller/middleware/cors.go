...
// CORSMiddleware description
type CORSMiddleware struct {
	logger logger.Logger
	env    config.Env
}

// NewCORSMiddleware description
func NewCORSMiddleware(logger logger.Logger, env config.Env) CORSMiddleware {
...
// Setup description
func (m CORSMiddleware) Setup() gin.HandlerFunc {
